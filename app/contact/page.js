                    ...
                    <section className="tf-section tf-contact pt60">
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-12" style={{display:"flex",justifyContent:"center",marginLeft:"20px"}}>
                                    <ul className="contact-info">
                                        ...
                                        <p style={{marginTop:"10px", marginLeft:"10px"}}>Telegram</p>
                                        </div>
                                            <div className="content" style={{marginTop:"13px"}}>
                                                <p className="color-hover">r@support.com</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div className="project-info-form">
                                            ...
                                            <div className="form-inner">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <textarea id="message" placeholder="Tell us about the project you wan to launch" rows={5} tabIndex={4} name="message" className="message" required />
                                                </fieldset>
                                            </div>
                                        </div>
